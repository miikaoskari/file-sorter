...
FilesorterApplication *filesorter_application_new(const char *application_id,
...
static void filesorter_application_activate(GApplication *app) {
    GtkWindow *window;
...
static void filesorter_application_class_init(FilesorterApplicationClass *klass) {
    GApplicationClass *app_class = G_APPLICATION_CLASS (klass);

    app_class->activate = filesorter_application_activate;
}

static void filesorter_application_about_action(GSimpleAction *action,
                                                GVariant *parameter,
                                                gpointer user_data) {
...
static void filesorter_application_quit_action(GSimpleAction *action,
                                               GVariant *parameter,
                                               gpointer user_data) {
    FilesorterApplication *self = user_data;
...
static void filesorter_application_init(FilesorterApplication *self) {
